...
const About = () => {
  ...
  return (
    <section id="about" ref={ref} className="section bg-secondary-50 dark:bg-secondary-800/30">
      <div className="container">
        ...
        >
          <h2 className="mb-4 text-secondary-900 dark:text-white">About Me</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 p-6 bg-white dark:bg-secondary-900 rounded-2xl shadow-lg">
                <p className="font-display font-bold">Angelo L. Almonte</p>
                <p className="text-secondary-600 dark:text-secondary-400 text-sm">Frontend Developer</p>
              </div>
            </div>
          </motion.div>
            ...
            <div className="grid grid-cols-2 gap-6">
              {aboutItems.map((item, index) => (
                ...
                >
                  ...
                  <h4 className="text-lg font-semibold mb-1 text-secondary-900 dark:text-white">
                    {item.title}
                  </h4>
